...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>SH</strong>hospitals </a>
...
<section class="doctors" id="doctors">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>Harsha Rajpoot</h3>
            <span>Dermetologist</span>
            <div class="share">
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-phone"></i> 9876756277 </a>
            <a href="#"> <i class="fas fa-phone"></i> 8448173007 </a>
            <a href="#"> <i class="fas fa-envelope"></i> sumitsinghr3007@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> itssamydude@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> Noida, India </a>
        </div>
    ...
    <div class="credit"> created by <span>Sumit Singh</span> | all rights reserved </div>
